...
{
    static constexpr bool cur_check = MiniorDedup_<typename TCurPolicy::MinorClass, TP...>::value;
...
using PolicySelect = typename NSPolicySelect::Select_<TMajorClass, TPolicyContainer>::type;
